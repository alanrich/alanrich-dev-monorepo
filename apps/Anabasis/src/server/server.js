...
app.use(
  cors({
    origin: allowedOrigins, // TODO: make sure localhost doesnt cause any cors errors, it shouldn't and we should be able to get rid of this son of a bitch now that its all going to be an heroku hosted app
